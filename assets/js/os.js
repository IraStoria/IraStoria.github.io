  ...
  var stage = (function () {
    ...
    function tick() {
      ...
      KEYS.forEach(function (k) {
        ...
        var horiz = !!u[0], dist = horiz ? geo.ex : geo.ey, r0 = STAGE_R0 * geo.ex * grow;   /* all four discs the same size (sized from the wider axis) */
        ...
        var a0 = 0.32 + 0.35 * rel + 0.12 * lvl, grd = g2.createRadialGradient(x, y, r0, x, y, r0 + Math.max(1, amp));   /* one shape only: where the wave is zero its outline IS the disc's edge */
